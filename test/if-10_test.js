...
QUnit.test("ЗАДАЧА 10. Написать функцию MonthName(n), которая по целому числу n - номеру месяца года, дает название этого месяца. Для n > 12 или n < 1 функция должна возвращать пустую строку."
  function(assert){
