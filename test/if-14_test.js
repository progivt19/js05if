...
QUnit.test("ЗАДАЧА 014. X4(x1, y1, x2, y2, x3, y3) and Y4(x1, y1, x2, y2, x3, y3)", function(assert){
    ...
    assert.deepEqual(f(1, 1, 7, 1, 4, 4), "Данные точки не могут быть вершинами прямоугольника", "Не выполнено f(0, 0, 6, 0, 4, 4) == Данные точки не могут быть вершинами прямоугольника")
});